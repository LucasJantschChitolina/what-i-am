...
export default function Header() {
  ...
  return (
    <>
      <Flex style={{ width: '70vw', height: '100px' }} justifyContent="space-between" fontSize="25px" border="0px solid red"  align="center">
        <Text width="70%">What I am Reading - Lucas Chitolina 👨‍💻</Text>
